...
class CacheDbConn:
    ...
    async def get_all_ratings_before_timestamp(
        self, timestamp: float
    ) -> list[cf.RatingChange]:
        """Returns, for every handle, its most recent rating change strictly
        before `timestamp`.
        """
        query = """
            SELECT contest_id, "Dummy", handle, rank, rating_update_time,
